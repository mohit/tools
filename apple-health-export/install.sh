...
echo ""
echo "  health-auto-export serve             # Run Health Auto Export API"
echo "  health-auto-export ingest-file       # Ingest JSON payload from file"
echo ""
echo "Or use the Python scripts directly:"
echo ""
echo "  python3 health_export.py --help"
echo "  python3 health_parser.py --help"
echo "  python3 health_auto_export.py --help"
echo ""
echo "Run tests with:"
echo ""
echo "  pytest"
